...
namespace parrot
{
    ...
    public class ParrotTest
    {
        ...
        public void GetSpeedOfEuropeanParrot()
        {
            ...
            Assert.AreEqual(12.0, parrot.Strategy.GetSpeed(parrot));
        }
        ...
        public void GetSpeedOfAfricanParrot_With_One_Coconut()
        {
            ...
            Assert.AreEqual(3.0, parrot.Strategy.GetSpeed(parrot));
        }
        ...
        public void GetSpeedOfAfricanParrot_With_Two_Coconuts()
        {
            ...
            Assert.AreEqual(0.0, parrot.Strategy.GetSpeed(parrot));
        }
        ...
        public void GetSpeedNorwegianBlueParrot_not_nailed()
        {
            ...
            Assert.AreEqual(18.0, parrot.Strategy.GetSpeed(parrot));
        }
        ...
        public void GetSpeedNorwegianBlueParrot_not_nailed_high_voltage()
        {
            ...
            Assert.AreEqual(24.0, parrot.Strategy.GetSpeed(parrot));
        }
    }
}
